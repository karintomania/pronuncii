...
class AssessmentServiceTest(TestCase):
    def setUp(self) -> None:
        ...
        def fake_get_sentences_for_test() -> models.QuerySet:
            return SentenceModel.objects.all().only("id").order_by("id")[: SentenceModel.objects.TEST_SENTENCES_COUNT]
    ...
    def test_init_sets_assessment_from_db(self) -> None:
        ...
        self.assertEqual(qset[0].pronunciation_sound_url, sentences[0].pronunciation_sound_url)
        ...
        self.assertEqual(qset[1].pronunciation_sound_url, sentences[1].pronunciation_sound_url)
    ...
    def test_init_sets_assessment_from_session(self) -> None:
        ...
        session_mock = {SessionService.ASSESSMENT_KEY: [sentence1.__dict__(), sentence2.__dict__()]}
        assessment_service = AssessmentService(session_mock)
        ...
        self.assertEqual(sentence1.pronunciation_sound_url, sentences[0].pronunciation_sound_url)
        ...
        self.assertEqual(sentence2.pronunciation_sound_url, sentences[1].pronunciation_sound_url)
