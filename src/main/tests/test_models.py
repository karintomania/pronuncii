...
class SentenceTest(TestCase):
    def setUp(self) -> None:
        Sentence.objects.create(sentence="test 1", pronunciation_sound_url = "url1",)
        Sentence.objects.create(sentence="test 2", pronunciation_sound_url = "url2",)
        Sentence.objects.create(sentence="test 3", pronunciation_sound_url = "url3",)
        Sentence.objects.create(sentence="test 4", pronunciation_sound_url = "url4",)
        Sentence.objects.create(sentence="test 5", pronunciation_sound_url = "url5",)
        Sentence.objects.create(sentence="test 6", pronunciation_sound_url = "url6",)
        return super().setUp()
